...
class AttendanceController {
  ...
  createAttendance = async (req, res) => {
    const attendance = new Attendance(req.body.user_id, req.body.class_id, req.body.attend_at, req.body.status, req.userData.id);
  ...
  updateAttendance = async (req, res) => {
    const attendance = new Attendance(req.body.user_id, req.body.class_id, req.body.status ? moment().format("YYYY-MM-DD HH:mm:ss") : null, req.body.status, req.userData.id);
